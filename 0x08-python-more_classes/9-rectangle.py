...
class Rectangle:
    ...
    def __str__(self):
        ...
        if self.width == 0 or self.height == 0:
            ...
            return "\n".join([self.print_symbol * self.__width] * self.height)
    ...
    def bigger_or_equal(rect_1, rect_2):
        ...
        Args:
            rect_1 (Rectangle instance): must be an instance of Rectangle
            rect_2 (Rectangle instance): must be an instance of Rectangle
        """
    ...
    def square(cls, size=0):
        ...
        Args:
            size (int): size of the rectangle. Defaults to 0.
        """
